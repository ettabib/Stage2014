...
nb_x0 = 10;
First_Int_Approx = CDS_spreads_AIG(1,1)/(1-Recovery);
...
for i = 1:Size_a
    for j = 1:Size_s
        for k = 1:Size_x0
            ...
            l = a + delta * k;
            L(k) = l;
            Bootstraped_Int = Bootstrap_intensities_ver_1(toDate, coupDate, Pillars', CDS_market_spreads(l,:)', Recovery, Interest, Intensity_model, CIR_Param);
...
for i = 1:Size_a
    for j = 1:Size_s
        for k = 1:Size_x0
            ...
            %Price = CDS_price(toDate, coupDate, Pillars, b', Recovery, Interest, 1, Param)
            %Price.Fair_spread;
