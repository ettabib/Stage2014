function Y =zeta_Gamma(s,y,a,sigma,lambda)
% s=1;
% y=0;
% a=2;
% sigma = 0.01;
% lambda = 0.01;
% Y=zeta_Gamma(s,y,a,sigma,lambda)
...
gamma0 = sigma*(1-a*y)/(a*(sigma*y + lambda));
...
pas = s/Nb_pas_tps;
x=(0:pas:s);
integrand = log(1+gamma0*(1-exp(-a*x)));
...
% Formule_Bugge = (1/a)*(dilog(1-param1) - dilog(1-param2) - log(param3)*log(param2))
% Terme2 = (1/a)*(dilog(1-param1))
% Terme3 = -(1/a)*(dilog(1-param2))
% Terme4 = -(1/a)*log(param3)*log(param2)
% Terme41 = log(param3)
% Terme42 = log(param2)


Y=log(alpha0)*s + Approx_int;
end
