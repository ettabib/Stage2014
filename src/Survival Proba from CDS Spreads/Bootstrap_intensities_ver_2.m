function res = Bootstrap_intensities_ver_2(pricing_date, next_coupon_date, pillars, CDS_market_spreads, Recovery, Interest, Intensity_model, Param)
% --------------------------------------------------------------------------------------------------
...
if isempty(intensities_without_one)
    Param = [last_Intensity; Param];
else
    Param = [intensities_without_one(1); Param];
end
