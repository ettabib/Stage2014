function res  = Proba_survi_OU_IG(t_scheduled,  intensities, t_pillars, IG_OU_Param)
% --------------------------------------------------------------------------------------------------
...
for k = 1:Nb_period
    ...
    %Coeff_c = zeta_IG(t, 0, a, sigma, lambda);
    Coeff_c = zeta_IG_exact(t, 0, a, sigma, lambda);
